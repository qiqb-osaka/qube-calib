...
353:def pingger(host):
364:class QuBE_ControlLine(DeviceWrapper):
366:  def connect(self, *args, **kw ):
397:  def get_connected(self):
409:  def number_of_shots(self):
412:  def number_of_shots(self,value):
416:  def repetition_time(self):
419:  def repetition_time(self,value_in_ns):
424:  def sequence_length(self):
427:  def sequence_length(self,value):
431:  def number_of_awgs(self):
435:  def list_of_awg_ids(self):
439:  def channel_enable(self):
443:  def enabled_channels(self):
447:  def enabled_awgs(self):
456:  def check_awg_channels(self,channels):
462:  def check_waveform(self,waveforms,channels):
485:  def upload_parameters(self,channels):
499:  def upload_waveform(self,waveforms,channels):
513:  def start_daq(self,awg_ids):
516:  def stop_daq(self,awg_ids,timeout):
519:  def get_lo_frequency(self):
522:  def set_lo_frequency(self,freq_in_mhz):
525:  def get_dac_coarse_frequency(self):
528:  def set_dac_coarse_frequency(self,freq_in_mhz):
533:  def get_dac_fine_frequency(self,channel):
536:  def set_dac_fine_frequency(self,channel,freq_in_mhz):
543:  def static_DACify(self, waveform):
547:  def static_get_dac_coarse_frequency(self,nco_ctrl,ch):
551:  def static_get_dac_coarse_ftw(self,nco_ctrl,ch):
560:  def static_check_lo_frequency(self,freq_in_mhz):
564:  def static_check_dac_coarse_frequency(self,freq_in_mhz):
568:  def static_check_dac_fine_frequency(self,freq_in_mhz):
576:  def static_check_repetition_time(self,reptime_in_nanosec):
580:  def static_check_sequence_length(self,seqlen_in_nanosec):
587:  def static_check_value(self,value,resolution,multiplier=50,include_zero=False):
594:class QuBE_ReadoutLine(QuBE_ControlLine):
596:  def connect(self, *args, **kw ):
634:  def get_connected(self):
645:  def acquisition_window(self):
648:  def set_acquisition_window(self,mux,window):
652:  def acquisition_mode(self):
655:  def set_acquisition_mode(self,mux,mode):
659:  def acquisition_mux_enable(self):
663:  def acquisition_enabled_channels(self):
674:  def set_acquisition_fir_coefficient(self,muxch,coeffs):
680:  def set_acquisition_window_coefficient(self,muxch,coeffs):
686:  def upload_readout_parameters(self,muxchs):
746:  def configure_readout_mode(self,mux,param,mode):
761:  def configure_readout_dsp(self,mux,param,mode):
770:  def configure_readout_decimation(self,mux,param,decimation):
790:  def configure_readout_averaging(self,mux,param,averaging):
809:  def configure_readout_summation(self,mux,param,summation):
836:  def download_waveform(self, muxchs):
858:  def download_single_waveform(self, muxch):
866:  def set_trigger_board(self, awg_board ):
872:  def set_adc_coarse_frequency(self,freq_in_mhz):
877:  def get_adc_coarse_frequency(self):
880:  def static_get_adc_coarse_frequency(self,nco_ctrl,ch):
884:  def static_get_adc_coarse_ftw(self,nco_ctrl,ch):
893:  def static_check_adc_coarse_frequency(self,freq_in_mhz):
897:  def static_check_mux_channel_range(self,mux):
901:  def static_check_acquisition_windows(self,list_of_windows):
916:  def static_check_acquisition_fir_coefs(self,coeffs):
924:  def static_check_acquisition_window_coefs(self,coeffs):
937:class QuBE_Server(DeviceServer):
945:  def initServer(self):
962:  def initContext(self, c):
969:  def chooseDeviceWrapper(self, *args, **kw):
973:  def instantiateChannel(self,name,channels,awg_ctrl,cap_ctrl,lsi_ctrl):
1013:  def instantiateQube(self,name,info):
1040:  def findDevices(self):
1065:  def number_of_shots(self,c,num_shots = None):
1085:  def repeat_count(self,c,repeat = None):
1101:  def repetition_time(self,c,reptime = None):
1125:  def sequence_length(self,c,length = None):
1150:  def daq_start(self,c):
1178:  def daq_trigger(self,c):
1189:  def daq_stop(self,c):
1199:  def daq_timeout(self,c,t = None):
1208:  def trigger_board(self,c,channel = None):
1221:  def upload_parameters(self,c,channels):
1241:  def upload_readout_parameters(self,c,muxchs):
1262:  def upload_waveform(self,c, wavedata,channels):
1293:  def download_waveform(self,c,muxchs):
1320:  def acquisition_count(self,c,acqcount = None):
1333:  def acquisition_number(self,c,muxch,acqnumb = None):
1360:  def acquisition_window(self,c,muxch,window = None):
1396:  def acquisition_mode(self,c,muxch,mode = None):
1455:  def acquisition_mux_enable(self,c,muxch = None):
1479:  def filter_pre_coefficients(self,c,muxch,coeffs):
1487:  def set_window_coefficients(self,c,muxch,coeffs):
1495:  def acquisition_fir_coefficients(self,c,muxch,coeffs):
1525:  def acquisition_window_coefficients(self,c,muxch,coeffs):
1556:  def local_frequency(self,c,frequency = None):
1583:  def coarse_tx_nco_frequency(self,c,frequency = None):
1611:  def fine_tx_nco_frequency(self,c,channel,frequency = None):
1647:  def coarse_rx_nco_frequency(self,c,frequency = None):
1660:class QuBE_Server_debug_otasuke(QuBE_Server):
1662:  def __init__(self,*args,**kw):
1666:  def debug_awg_ctrl_reg(self,c, addr, offset, pos, bits, data = None):
1696:  def debug_cap_ctrl_reg(self,c, addr, offset, pos, bits, data = None):
1728:  def debug_auto_acquisition_fir_coefficients(self,c,muxch,bb_frequency,sigma = None):
1769:  def debug_auto_acquisition_window_coefficients(self,c,muxch,bb_frequency):
1822:class Qube_Manager_Device(DeviceWrapper):
1824:  def connect(self, *args, **kw):
1834:  def initialize(self):
1838:  def verbose(self):
1841:  def verbose(self,x):
1845:class Qube_Manager_Server(DeviceServer):
1852:  def initServer(self):
1865:  def extract_links(self,link):
1869:  def initContext(self, c):
1873:  def findDevices(self):
1896:  def instantiateQube(self, name, iplsi, qube_type):
1902:  def device_reinitialize(self,c):
1917:  def debug_verbose_message(self,c,flag = None):
1938:def basic_config():
2079:def load_config(cxn,config):
2099:def usage():
2257:def test_control_ch(device_name):
2286:def test_control_ch_bandwidth(device_name):
2329:def test_readout_ch_bandwidth_and_spurious(device_name):
2336:  def spectrum_analyzer_get():
2376:  def experiment_nco_sweep( vault, fnco, file_idx ):
2446:if server_select is None:
...
594:class QuBE_ReadoutLine(QuBE_ControlLine):
937:class QuBE_Server(DeviceServer):
1064:  @setting(100, 'Shots', num_shots = ['w'], returns=['w'])
1084:  @setting(101, 'Repeat Count', repeat = ['w'], returns=['w'])
1100:  @setting(102, 'Repetition Time', reptime = ['v[s]'], returns=['v[s]'])
1124:  @setting(103, 'DAQ Length', length = ['v[s]'], returns = ['v[s]'])
1149:  @setting(105, 'DAQ Start', returns = ['b'])
1177:  @setting(106, 'DAQ Trigger', returns = ['b'])
1188:  @setting(107, 'DAQ Stop', returns = ['b'])
1198:  @setting(108, 'DAQ Timeout', t = ['v[s]'], returns = ['v[s]'])
1207:  @setting(109, 'Trigger Board', channel = ['w'], returns = ['b'])
1220:  @setting(200, 'Upload Parameters', channels=['w','*w'],returns=['b'])
1240:  @setting(201, 'Upload Readout Parameters', muxchs=['*w','w'],returns=['b'])
1261:  @setting(202, 'Upload Waveform', wavedata =['*2c','*c'], channels=['*w','w'],returns=['b'])
1292:  @setting(203, 'Download Waveform', muxchs = ['*w','w'], returns = ['*c','*2c'])
1319:  @setting(300, 'Acquisition Count', acqcount = ['w'], returns = ['w'])
1332:  @setting(301, 'Acquisition Number', muxch = ['w'], acqnumb = ['w'], returns = ['w'])
1359:  @setting(302, 'Acquisition Window', muxch = ['w'], window = ['*(v[s]v[s])'], returns=['*(v[s]v[s])'])
1395:  @setting(303, 'Acquisition Mode', muxch = ['w'], mode = ['s'], returns=['s'])
1454:  @setting(304, 'Acquisition Mux Enable', muxch = ['w'], returns = ['b','*b'])
1478:  @setting(305, 'Filter Pre Coefficients', muxch = ['w'], coeffs = ['*c'], returns = ['b'])
1486:  @setting(306, 'Average Window Coefficients', muxch = ['w'], coeffs = ['*c'], returns = ['b'])
1494:  @setting(307, 'Acquisition FIR Coefficients', muxch = ['w'], coeffs = ['*c'], returns = ['b'])
1524:  @setting(308, 'Acquisition Window Coefficients', muxch = ['w'], coeffs = ['*c'], returns = ['b'])
1555:  @setting(400, 'Frequency Local', frequency = ['v[Hz]'], returns = ['v[Hz]'])
1582:  @setting(401, 'Frequency TX NCO', frequency = ['v[Hz]'], returns = ['v[Hz]'])
1610:  @setting(402, 'Frequency TX Fine NCO', channel = ['w'], frequency = ['v[Hz]'], returns = ['v[Hz]'])
1646:  @setting(403, 'Frequency RX NCO', frequency = ['v[Hz]'], returns = ['v[Hz]'])
1660:class QuBE_Server_debug_otasuke(QuBE_Server):
1665:  @setting(502, 'DEBUG AWG REG', addr = ['w'], offset = ['w'], pos = ['w'], bits = ['w'], data = ['w'], returns = ['w'])
1695:  @setting(501, 'DEBUG CAP REG', addr = ['w'], offset = ['w'], pos = ['w'], bits = ['w'], data = ['w'], returns = ['w'])
1727:  @setting(503, 'DEBUG Auto Acquisition FIR Coefficients', muxch = ['w'], bb_frequency = ['v[Hz]'], sigma = ['v[s]'], returns = ['b'])
1768:  @setting(504, 'DEBUG Auto Acquisition Window Coefficients', muxch = ['w'], bb_frequency = ['v[Hz]'], returns = ['b'])
1822:class Qube_Manager_Device(DeviceWrapper):
1845:class Qube_Manager_Server(DeviceServer):
1901:  @setting(100, 'Reset', returns=['b'])
1916:  @setting(200, 'Debug Verbose', flag = ['b'], returns=['b'])
"""
...
class QSConstants:
  ...
  ADCDCM_SAMPLE_R    = 62.5                                 # MHz, decimated sampling frequency
  DAC_BITS           = 16                                   # bits
  ...
  ACQ_MAX_FCOEF      = 16                                   # 8-tap FIR filter before decimation
  ACQ_FCOEF_BITS     = 16                                   # bits; FIR bits
  ACQ_FCBIT_POW_HALF = 2**15                                # 2^(ACQ_FCOEF_BITS-1)
  ACQ_MAX_WCOEF      = 128                                  # points = 2048 ns
  ACQ_WCOEF_BITS     = 31                                   # bits
